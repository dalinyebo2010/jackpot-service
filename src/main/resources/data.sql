...
INSERT INTO jackpot (name, initial_pool, current_pool, contribution_strategy, reward_strategy, contribution_percentage, created_at, updated_at)
VALUES ('Fixed Reward Jackpot - Winner', 1000.00, 6000.00, 'FIXED', 'FIXED', 0.05, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Fixed reward jackpot: pool <= 5000 means no win
INSERT INTO jackpot (name, initial_pool, current_pool, contribution_strategy, reward_strategy, contribution_percentage, created_at, updated_at)
VALUES ('Fixed Reward Jackpot - No Winner', 1000.00, 4000.00, 'FIXED', 'FIXED', 0.05, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Variable reward jackpot: pool divisible by 7 triggers a win
INSERT INTO jackpot (name, initial_pool, current_pool, contribution_strategy, reward_strategy, contribution_percentage, created_at, updated_at)
VALUES ('Variable Reward Jackpot - Winner', 1000.00, 7000.00, 'VARIABLE', 'VARIABLE', 0.10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Variable reward jackpot: pool not divisible by 7 means no win
INSERT INTO jackpot (name, initial_pool, current_pool, contribution_strategy, reward_strategy, contribution_percentage, created_at, updated_at)
VALUES ('Variable Reward Jackpot - No Winner', 1000.00, 7500.00, 'VARIABLE', 'VARIABLE', 0.10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Seed bets tied to those jackpots
--INSERT INTO bets (user_id, jackpot_id, amount, created_at)
--VALUES (101, 1, 100.00, CURRENT_TIMESTAMP); -- Bet for Fixed Reward Jackpot - Winner

--INSERT INTO bets (user_id, jackpot_id, amount, created_at)
--VALUES (102, 2, 200.00, CURRENT_TIMESTAMP); -- Bet for Fixed Reward Jackpot - No Winner

--INSERT INTO bets (user_id, jackpot_id, amount, created_at)
--VALUES (103, 3, 150.00, CURRENT_TIMESTAMP); -- Bet for Variable Reward Jackpot - Winner

--INSERT INTO bets (user_id, jackpot_id, amount, created_at)
--VALUES (104, 4, 250.00, CURRENT_TIMESTAMP); -- Bet for Variable Reward Jackpot - No Winner
